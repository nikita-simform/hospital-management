...
const { httpGetAllPatients, httpSavePatient, httpUpdatePatient, httpDeletePatient } = require("./patient.controller");
...
const patientValidations=[
    ...
    check("contact_number",'contact number should be of 10 numbers').isLength({min:10,max:10}),
...
patientRouter.put('/update',verifyToken,patientValidations,httpUpdatePatient);
patientRouter.delete("/:id",httpDeletePatient)
